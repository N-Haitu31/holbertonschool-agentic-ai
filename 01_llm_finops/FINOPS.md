...
**Vérification mathématique du total.** Plutôt que de faire confiance à la somme ligne par ligne du tableau, on peut recalculer le total directement à partir des sommes globales d'input et d'output : Σ inputs = 173 260 tokens et Σ outputs = 5 000 tokens, donc `Coût total = (173 260 / 1 000 000 × 5$) + (5 000 / 1 000 000 × 15$) = 0,8663 $ + 0,075 $ = 0,9413 $`. Ce résultat est cohérent avec la somme des 10 coûts individuels du tableau, ce qui confirme l'absence d'erreur d'addition.
